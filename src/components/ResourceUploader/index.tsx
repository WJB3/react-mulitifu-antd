...
const ResourceUploader = (props) => {
    ...
    return (
        <div style={{ display: 'flex' }}>
            ...
            <CustomUploader   visible={imgVisible} max={1} size={10000000} ref={imgLoaderRef} extraAccept={type==='image'?[]:['dmg','xip','pptx','tif','cdr','7z','rar','sql','zip', 'doc', 'docx', 'pdf','video']} successUploader={handleSuccessUpload} onCancel={() => setImgVisible(false)} /> 
